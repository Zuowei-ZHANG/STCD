...
def get_config():
    ...
    parameters_dict = {
        ...
        'River': [60, 10, 20, 0.3, 20, 0.3, 1500, 4],
        'Gloucester': [60, 20, 100, 0.65, 20, 0.3, 2000, 4],
        'Gloucester_': [100, 40, 80, 0.3, 20, 0.2, 1500, 6],  #80 0.3  100 0.25
        'California': [120, 10, 20, 0.3, 20, 0.3, 1500, 4],
        'Texas': [35, 14, 50, 0.3, 20, 0.3, 2000, 4],  #0.3
        'wuhan': [80, 20, 40, 0.15, 20, 0.3, 300, 3],
        'Yellow_River': [110, 10, 20, 0.3, 20, 0.3, 1000, 4],
    }
